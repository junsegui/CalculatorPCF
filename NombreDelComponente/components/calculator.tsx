...
import { TaxCalculatorViewModel } from "../viewmodels/TaxCalculatorViewModels";
      ...
      <Stack horizontal>
        {calculateMode && (
          <>
            ...
            />
            <IconButton iconProps={{ iconName: "Accept" }} onClick={vm.onAccept} style={{ color: SharedColors.magenta20 }} />
